...
A generic, client-side paywall component for x402 payments that drops into React or Next.js apps. It reproduces the EIP-3009 signing flow from the reference HTML paywall in `namefi-astra`, but wraps it in a composable React component.
