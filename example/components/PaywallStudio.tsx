...
const themes: Record<string, ThemeConfig> = {
  ...
  slate: {
    ...
    border: 'rgba(15, 23, 42, 0.12)',
    borderRadius: '20px',
    appName: 'Slate Systems',
    appLogo: 'https://dummyimage.com/96x32/14b8a6/ffffff&text=Slate',
  },
  noir: {
    background: '#0b0f1a',
    card: '#111827',
  ...
  return (
    <div className="app">
      <div className="app__header">
        ...
        <p>
          A modern x402 checkout. Customize the theme and brand identity,
          ...
          <section className="panel">
            <div className="panel__header">
              <div>
                ...
                <p className="panel__subtitle">Theme, brand, and dev controls</p>
              </div>
              <button
                type="button"
            ...
            {themeKey === CUSTOM_THEME_KEY && (
              <div className="panel__section">
                ...
                <input
                  ...
                  value={customTheme.appName ?? ''}
                  onChange={(e) => updateCustomTheme({ appName: e.target.value })}
                />
                ...
                <input
                  ...
                  type="text"
                  placeholder="https://..."
                  value={customTheme.appLogo ?? ''}
                  onChange={(e) => updateCustomTheme({ appLogo: e.target.value })}
                />
              </div>
            )}
